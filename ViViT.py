...
class ViViT(nn.Module):
    def __init__(self, image_size=32, patch_size=4, num_classes=10, num_frames=120, dim=192, depth=4, heads=3, pool='cls', in_channels=2, dim_head=64, dropout=0.,
...
if __name__ == "__main__":
    ...
    img = torch.ones([10, 120, 2, 16, 16]).cuda()
